...
import rkm from '../public/assets/Sursangam-[DoPy] (28).jpg'
...
export default function Hero() {
  ...
  "
      ...
      <img src={rkm.src} className="z-5 absolute top-[-125px]" />

      <div className="-z-2 absolute -left-64  -top-56 aspect-square  h-[150vh] scale-90 bg-contain bg-center  bg-no-repeat opacity-60 blur-md md:-left-32 md:blur-md  lg:left-1/3 lg:-top-56 lg:h-[150vh] lg:blur-0" />
